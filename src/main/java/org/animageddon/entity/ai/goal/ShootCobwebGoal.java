...
import org.animageddon.entity.interfaces.SpiderEntityAdded;
...
public class ShootCobwebGoal extends Goal
{
    ...
    public ShootCobwebGoal(SpiderEntity spider)
    {
        this.spider = spider;
    }
    ...
    public void tick()
    {
        ...
        if (livingEntity != null)
        {
            ...
            if (livingEntity.squaredDistanceTo(this.spider) < 4096.0 && this.spider.canSee(livingEntity)) {
                ...
                {
                    world.syncWorldEvent(null, 1015, this.spider.getBlockPos(), 0);
                }
                ...
                if (this.cooldown == 20)
                {
                    ...
                    CobwebEntity cobwebEntity = new CobwebEntity(world, this.spider, f, g, h);
                    cobwebEntity.setPosition(this.spider.getX() + vec3d.x * 4.0, this.spider.getBodyY(0.5) + 0.5, cobwebEntity.getZ() + vec3d.z * 4.0);
