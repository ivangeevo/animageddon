...
# v???(dev)
+ Changed cows to be milked only once a day and to initially spawn without milk. This is a temporary behavior until the change for animals requiring to eat food is implemented into the mod
